...
**Composition.** As part of the migration, run the Design Direction Gate and confirm the composition
from `compositions/`: state the product class, the composition, a justified variant, and the dominant
